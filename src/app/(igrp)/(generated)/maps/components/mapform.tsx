...
export default function Mapform({ initialData, isSubmitting, onAfterSubmit } : { initialData?: any, isSubmitting: boolean, onAfterSubmit: () => void }) {
  ...
  const form1 = z.object({
    ...
    longitude: z.number(),
    zoom: z.number(),
    layers: z.array(z.object({ associationId: z.string().optional(), layerId: z.string().optional(), visibility: z.string().optional(), groupId: z.string().optional(), order: z.number().optional() })).optional(),
...
const initForm1: z.infer<Form1ZodType> = {
    ...
    longitude: 0,
    zoom: 0,
    layers: [{ associationId: undefined, layerId: ``, visibility: ``, groupId: ``, order: undefined }],
